...
import heroImg from "../public/0.svg";
...
export default function Home() {
  ...
  // User's balance of AiMints NFTs
  ...
  return (
    <div>
      ...
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to De Devs!</h1>
          <div className={styles.description}>Welcome to the DAO!</div>
          <div className={styles.description}>
            Your AiMints NFT Balance: {nftBalance}
            <br />
        ...
        <div>
          <Image className={styles.image} src={heroImg} alt="hero image" width={500} height={500} />
        </div>
      </div>
